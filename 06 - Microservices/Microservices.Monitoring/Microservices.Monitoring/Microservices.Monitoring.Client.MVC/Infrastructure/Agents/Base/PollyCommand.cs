...
namespace Microservices.Monitoring.Client.MVC.Infrastructure.Agents.Orders.Commands
{    
    using System;
    public class PollyCommand<T>
    {
        ...
        private int maxExceptionsBeforeBreaking = 2; /* experiment with effect of fewer here, eg change to = 1, and the fallbackForCircuitBreaker is correctly invoked */
