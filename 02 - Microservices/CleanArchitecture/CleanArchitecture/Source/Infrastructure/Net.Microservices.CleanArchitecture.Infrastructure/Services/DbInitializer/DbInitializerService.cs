...
namespace Net.Microservices.CleanArchitecture.Infrastructure.Services
{
    internal class DbInitializerService : IDbInitializerService
    {
        ...
        public void Seed() {
            ...
            var applicationUsers = _identityContext.Users;
            var applicationUserRoles = _identityContext.UserRoles;
            if (!applicationUsers.Any())
            {
                var superAdminRole = applicationRoles.Find("8fa3842a-98a4-475b-8926-fce6efdc3e6f");
                var adminRole = applicationRoles.Find("40e668a2-8a53-4907-817c-e4f8c8f72fb4");
                var superAdminUser = new ApplicationUser()
                {
                    Id = "056aa47a-7c7e-4c16-8219-8b1ef65d7618",
                    Email = "superadmin@todo.local",
                    EmailConfirmed = true,
                    IsActive = true,
                    Name = "SuperAdmin",
                    UserName = "SuperAdmin",
                    NormalizedEmail = "SUPERADMIN@TODO.LOCAL",
                    NormalizedUserName = "SUPERADMIN",
                    PasswordHash = PasswordHasher.HashPassword("SuperAdmin")
                };
                applicationUsers.Add(superAdminUser);
                applicationUserRoles.Add(new ApplicationUserRole { User = superAdminUser, Role = superAdminRole });
                applicationUserRoles.Add(new ApplicationUserRole { User = superAdminUser, Role = adminRole });
            }
